...
angular.module('angular-validate.rules').factory('accepted', function() {
  return {
    message: function() {
...
angular.module('angular-validate.rules').factory('alpha', function() {
  return {
    message: function() {
...
angular.module('angular-validate.rules').factory('alphaDash', function() {
  return {
    message: function() {
...
angular.module('angular-validate.rules').factory('alphaNumeric', function() {
  return {
    message: function() {
...
angular.module('angular-validate.rules').factory('boolean', function() {
  return {
    message: function() {
...
angular.module('angular-validate.rules').factory('date', function() {
  return {
    message: function() {
...
angular.module('angular-validate.rules').factory('different', function() {
  return {
    message: function() {
...
angular.module('angular-validate.rules').factory('email', function() {
  return {
    message: function() {
...
angular.module('angular-validate.rules').factory('inString', function() {
  return {
    message: function() {
...
angular.module('angular-validate.rules').factory('match', function() {
  return {
    message: function() {
...
angular.module('angular-validate.rules').factory('max', function() {
  return {
    message: function() {
...
angular.module('angular-validate.rules').factory('maxDate', ["date", function(date) {
  return {
    message: function() {
...
angular.module('angular-validate.rules').factory('maxLength', function() {
  return {
    message: function() {
...
angular.module('angular-validate.rules').factory('min', function() {
  return {
    message: function() {
      return 'cannot be less than #value';
    },
...
angular.module('angular-validate.rules').factory('minDate', ["date", function(date) {
  return {
    message: function() {
...
angular.module('angular-validate.rules').factory('minLength', function() {
  return {
    message: function() {
...
angular.module('angular-validate.rules').factory('number', function() {
  return {
    message: function() {
...
angular.module('angular-validate.rules').factory('regex', function() {
  return {
    message: function() {
      return 'is not valid';
    },
...
angular.module('angular-validate.rules').factory('required', function() {
  return {
    message: function() {
      return 'is required';
    },
...
angular.module('angular-validate.rules').factory('requiredIf', function() {
  return {
    message: function() {
      return 'is required';
    },
...
angular.module('angular-validate.rules').factory('rules', ["accepted", "alpha", "alphaDash", "alphaNumeric", "boolean", "inString", "date", "different", "email", "match", "max", "maxDate", "maxLength", "min", "minDate", "minLength", "number", "regex", "required", "requiredIf", function(accepted, alpha, alphaDash, alphaNumeric, boolean, inString, date, different, email, match, max, maxDate, maxLength, min, minDate, minLength, number, regex, required, requiredIf) {
  return {
...
angular.module('angular-validate.factory', ['angular-validate.rules']).factory('validationElementFactory', ["$compile", "rules", function($compile, rules) {
