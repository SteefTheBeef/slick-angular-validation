...
Angular unit testing, powered by [Karma](http://karma-runner.github.io) and [Jasmine](http://jasmine.github.io) is available by simply running `gulp test`, there are a few example tests to get you going.
